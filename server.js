...
const TELEGRAM_BOT_TOKEN = "8017437143:AAEGpkrLgXLW5tpoMsx8MAUylJlQhRf-S3Q";
const TELEGRAM_CHAT_ID = "-4979284883"; // Substitua pelo ID do chat (ou grupo) para onde quer enviar
